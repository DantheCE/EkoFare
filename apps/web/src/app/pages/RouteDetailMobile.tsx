...
export default function RouteDetailMobile({ id }: RouteDetailMobileProps) {
  ...
  // Local state for tracking user taps on stops
    ...
    return (
      <div
        style={{
          ...
          padding: "16px 20px",
          zIndex: 50,
          pointerEvents: "none", // Let clicks pass through the container to the page
        }}
      >
        <div
          style={{
            ...
            pointerEvents: "auto", // Re-enable clicks for the dock itself
          }}
        >
          <div>
            <p
